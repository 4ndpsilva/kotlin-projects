...
INSERT INTO TB_LANCAMENTO(DATA, CATEGORIA_ID, CONTA_ID, VALOR, OPERACAO, OBSERVACAO) VALUES('2019-05-21', 1, 3, 5.69, 'DEBITO', '');
INSERT INTO TB_LANCAMENTO(DATA, CATEGORIA_ID, CONTA_ID, VALOR, OPERACAO, OBSERVACAO) VALUES('2019-05-20', 1, 2, 1.69, 'DEBITO', '');
INSERT INTO TB_LANCAMENTO(DATA, CATEGORIA_ID, CONTA_ID, VALOR, OPERACAO, OBSERVACAO) VALUES('2018-05-01', 2, 5, 500.00, 'DEBITO', '');
INSERT INTO TB_LANCAMENTO(DATA, CATEGORIA_ID, CONTA_ID, VALOR, OPERACAO, OBSERVACAO) VALUES('2018-01-11', 1, 3, 2.65, 'DEBITO', '');
INSERT INTO TB_LANCAMENTO(DATA, CATEGORIA_ID, CONTA_ID, VALOR, OPERACAO, OBSERVACAO) VALUES('2019-01-20', 6, 8, 1200.00, 'CREDITO', '');
INSERT INTO TB_LANCAMENTO(DATA, CATEGORIA_ID, CONTA_ID, VALOR, OPERACAO, OBSERVACAO) VALUES('2019-02-10', 3, 9, 11.60, 'DEBITO', '');
INSERT INTO TB_LANCAMENTO(DATA, CATEGORIA_ID, CONTA_ID, VALOR, OPERACAO, OBSERVACAO) VALUES('2019-03-10', 3, 9, 9.69, 'DEBITO', '');
INSERT INTO TB_LANCAMENTO(DATA, CATEGORIA_ID, CONTA_ID, VALOR, OPERACAO, OBSERVACAO) VALUES('2019-03-20', 6, 7, 968.00, 'CREDITO', '');
INSERT INTO TB_LANCAMENTO(DATA, CATEGORIA_ID, CONTA_ID, VALOR, OPERACAO, OBSERVACAO) VALUES('2019-05-05', 1, 3, 1.69, 'DEBITO', '');
INSERT INTO TB_LANCAMENTO(DATA, CATEGORIA_ID, CONTA_ID, VALOR, OPERACAO, OBSERVACAO) VALUES('2019-05-06', 1, 3, 3.79, 'DEBITO', '');
INSERT INTO TB_LANCAMENTO(DATA, CATEGORIA_ID, CONTA_ID, VALOR, OPERACAO, OBSERVACAO) VALUES('2019-06-01', 2, 5, 500.00, 'DEBITO', '');